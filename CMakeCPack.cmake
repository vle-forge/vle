...
SET(CPACK_DEBIAN_PACKAGE_NAME ${VLE_LOCALE_NAME})
...
IF (CPACK_GENERATOR MATCHES "NSIS")
  ...
  SET(BOOST_INCLUDEDIR_NEW CACHE PATH "Boost include directory")
  SET(BOOST_LIBRARYDIR_NEW CACHE PATH "Boost library directory")
  SET(MINGW_BASE CACHE PATH "Mingw Boost directory")
  SET(GTK_BASE CACHE PATH "Gtk directory")
  ...
  INSTALL(DIRECTORY "${BOOST_LIBRARYDIR_NEW}/" DESTINATION bin
    FILES_MATCHING PATTERN "libboost*.dll")
  INSTALL(DIRECTORY "${BOOST_LIBRARYDIR_NEW}/" DESTINATION lib
    FILES_MATCHING PATTERN "libboost*.a")

  # Mingw library
  INSTALL(FILES "${MINGW_BASE}/bin\\\\mingwm10.dll" DESTINATION bin)

  # Gtk, Gtkmm libraries and headers
  INSTALL(DIRECTORY "${GTK_BASE}/include/" DESTINATION include)
  INSTALL(DIRECTORY "${GTK_BASE}/redist/" DESTINATION bin)

  INSTALL(FILES "${GTK_BASE}/bin\\\\pkg-config.exe" DESTINATION bin)

  INSTALL(DIRECTORY "${GTK_BASE}/lib/" DESTINATION lib
    PATTERN "*.def" EXCLUDE
    PATTERN "*.lib" EXCLUDE)
