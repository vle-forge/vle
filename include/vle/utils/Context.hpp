...
public:
    ...
    /**
     * @brief Give an access to the underlying private context implementation.
     * @return A smart pointer and can be nullptr.
     */
    const std::unique_ptr<PrivateContextImpl>& get_impl() const
    {
        return m_pimpl;
    }
