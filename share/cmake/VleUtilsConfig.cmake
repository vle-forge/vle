...
macro(VleCheckPackage _prefix _module_with_version)
  ...
  if (EXISTS "${_vle_include_dirs}" OR EXISTS "${_vle_lib_dirs}"
    ...
    set(_vle_include_dirs "${VLE_LIBRARY_DIRS}/vle-${VLE_ABI_VERSION}/pkgs/${_module}/src")
    set(_vle_lib_dirs "${VLE_LIBRARY_DIRS}/vle-${VLE_ABI_VERSION}/pkgs/${_module}/lib")
    set(_vle_plugin_dirs "${VLE_LIBRARY_DIRS}/vle-${VLE_ABI_VERSION}/pkgs/${_module}/plugins")
    if (EXISTS "${_vle_include_dirs}" OR EXISTS "${_vle_lib_dirs}"
        OR EXISTS "${_vle_plugin_dirs}")
      if (WIN32)
        file(GLOB _vle_libraries "${_vle_lib_dirs}/*.a" "${_vle_lib_dirs}/*.dll")
      ...
      if (_vle_debug)
        message(STATUS "Found `${_module}': ${_vle_libraries} and "
                       "${_vle_include_dirs} into system pkgs")
      endif ()
    else ()
