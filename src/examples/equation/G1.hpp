...
namespace vle { namespace examples { namespace equation {
    ...
    class G1 : public extension::DifferenceEquation::Simple
    {
        Var g;

    public:
        G1(const devs::DynamicsInit& model,
...
DECLARE_NAMED_DYNAMICS(G1, vle::examples::equation::G1)
