...
#ifndef GVLE_DEFAULT_DATA_PANEL_H
#define GVLE_DEFAULT_DATA_PANEL_H
...
class DefaultDataPanel : public PluginMainPanel
{
    Q_OBJECT;
...
public:
    ...
    PluginMainPanel* newInstance() override {return new DefaultDataPanel();}
public slots:
...
private:
    void initData(QString pkg, QString classname, QString filePath);
};
