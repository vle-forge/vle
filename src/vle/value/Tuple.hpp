...
namespace vle { namespace value {
    ...
    public:
         ...
         * @return A new Tuple allocated from the boost::pool.
         */
        static Tuple* create()
        { return new Tuple(); }
	...
	virtual void writeString(std::ostream& out) const;
        ...
        /**
         * @brief Push all real from the TupleValue. The XML representation of
         * this class is:
         * @code
	...
	virtual void writeXml(std::ostream& out) const;
         ...
         * Be careful, the index is not tested.
