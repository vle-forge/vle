...
Condition &Condition::operator=(const Condition &cnd)
{
    Condition tmp(cnd);
...
void Condition::del(const std::string &portname) { m_list.erase(portname); }
...
std::vector<std::shared_ptr<value::Value>> &Condition::lastAddedPort()
{
