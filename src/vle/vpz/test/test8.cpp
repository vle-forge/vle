...
void test_clone_different_atomic()
{
    auto ctx = vle::utils::make_context();
...
void test_atomic_model_source_2()
{
    auto ctx = vle::utils::make_context();
    vpz::Vpz file(ctx->getTemplate("unittest.vpz").string());
...
void test_atomic_model_source_3()
{
    auto ctx = vle::utils::make_context();
    vpz::Vpz file(ctx->getTemplate("unittest.vpz").string());
