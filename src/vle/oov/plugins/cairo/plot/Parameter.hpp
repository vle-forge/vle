/**
 * @file vle/oov/plugins/cairo/plot/Parameter.hpp
...
public :
    ...
    const void get_screen_size(int & width, int & height);
    void set_drawing_area_size(int width, int height);
    const void get_drawing_area_size(int & width, int & height);
    void set_shift_left(int value);
    const int get_shift_left();
    void set_shift_right(int value);
    const int get_shift_right();
    void set_shift_top(int value);
    const int get_shift_top();
    ...
    const int get_graph_zone_width();
    ...
    const bool get_scrolling();
    void init();
    void set_min_draw_index(int index);
    const int get_min_draw_index();
    void set_max_draw_index(int index);
    const int get_max_draw_index();
    void inc_max_draw_index();
    const bool is_smaller(double value);
    ...
    const int to_pixel_width(double date);
    const int get_height_bottom_axe();
    const double pixel_to_date(int pixel);
    const double pixel_to_value_height(int pixel);
    const int get_y0_axe();
    void update_m_y0();
    const bool is_inside_min_max(double value);
};
