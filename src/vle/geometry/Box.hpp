 ...
 * @date ven, 27 oct 2006 16:56:25 +0200
 */
 ...
 */
	 ...
	 */
	inline Box(const Point<n, Class>& lower, const Point<n, Class>& upper) :
	    m_lower(lower),
	    m_upper(upper)
	    {
		normalize();
	 ...
	 * @param The upper corner of the box.
	 */
	...
	/**
	 * Sets the min values to the lower corner. Sets the max values to the
	 * upper corner.
	 */
