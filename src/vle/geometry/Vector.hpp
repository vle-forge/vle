/**
 * @file src/vle/geometry/Vector.hpp
...
public:
     ...
     * with value.
     * @param value The element which initializes the elements of the vector.
     */
    ...
    /**
     * Constructs a vector of length n, containing n values initialized with
     * the first n elements pointed by values. The array pointed by values must
     * contain at least n values.
     * @param values The elements which initializes the elements of the vector.
     */
