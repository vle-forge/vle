...
#define DECLARE_TRANSLATOR(x) \
    extern "C" { utils::Translator* makeNewTranslator \
...
/**
 * @brief Class to translate original XML application into VLE XML application.
 * Translation use tag NO_VLE from VLE project XML and translate it.
 */
class Translator
{
public :
    ...
    /** @return XML Node list from XML Graphics. */
    xmlpp::Node::NodeList getGraphics() const
    { return m_graphics->get_root_node()->get_children(); }
