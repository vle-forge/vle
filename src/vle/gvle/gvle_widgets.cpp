...
VleCodeHighlighter::VleCodeHighlighter(QTextDocument* parent)
...
void
VleCodeHighlighter::highlightBlock(const QString& text)
{
...
{
    return QSize(codeEditor->VleCodelineNumberAreaWidth(), 0);
}

void
VleCodeLineNumberArea::paintEvent(QPaintEvent* event)
{
    codeEditor->VleCodelineNumberAreaPaintEvent(event);
}

VleCodeEdit::VleCodeEdit(QWidget* parent)
  : QPlainTextEdit(parent)
{
    ...
    m_highlighter = new VleCodeHighlighter(document());
    m_lineNumberArea = new VleCodeLineNumberArea(this);
...
void
VleCodeEdit::setTextEdition(bool val)
{
...
QString
VleCodeEdit::getSavedText()
{
    return saved_value;
}
QString
VleCodeEdit::getCurrentText()
{
    return document()->toPlainText();
}

void
VleCodeEdit::setText(const QString& text)
{
    this->document()->setPlainText(text);
    saved_value = text;
}
...
void
VleCodeEdit::mouseDoubleClickEvent(QMouseEvent* e)
{
    if (edit_on_dble_click) {
        setTextEdition(true);
    } else {
...
int
VleCodeEdit::VleCodelineNumberAreaWidth()
{
    int digits = 1;
...
void
VleCodeEdit::updateVleCodeLineNumberAreaWidth(int /* newBlockCount */)
{
    setViewportMargins(VleCodelineNumberAreaWidth(), 0, 0, 0);
}

void
VleCodeEdit::updateVleCodeLineNumberArea(const QRect& rect, int dy)
{
    if (dy)
...
void
VleCodeEdit::resizeEvent(QResizeEvent* e)
{
    QPlainTextEdit::resizeEvent(e);

    QRect cr = contentsRect();
    m_lineNumberArea->setGeometry(
      QRect(cr.left(), cr.top(), VleCodelineNumberAreaWidth(), cr.height()));
}

void
VleCodeEdit::highlightCurrentLine()
{
...
void
VleCodeEdit::VleCodelineNumberAreaPaintEvent(QPaintEvent* event)
{
