...
/**
 * @brief A virtual class to define the modelling plugin.
...
public:
    ...
    /**
     * return the name of formalism like "ODE", "PetriNet"... Be carreful,
     ...
     * @return true if successful, otherwise false
     */
    virtual bool getXML(std::string& structure,
...
#define DECLARE_GVLE_PLUGIN(x) \
    extern "C" { gPlugin* makeNewPlugin(void) { return new x(); } }
