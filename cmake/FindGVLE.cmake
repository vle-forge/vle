...
#
#  VLE_VERSION        - gives the VLE version to search for (e.g 1.3 2.0)
#                       (REQUIRED)
...
if (NOT DEFINED VLE_VERSION)
  message (FATAL_ERROR "Cmake variable VLE_VERSION is not set")
endif ()
...
if (${_find_gvle_using_cmake})
  ...
  find_path(_gvle_base_include vle-${VLE_VERSION}/vle/gvle/gvle_widgets.h PATHS
    $ENV{VLE_BASEPATH}/include
    ${VLE_BASEPATH_LOCAL}/include
    "[HKEY_LOCAL_MACHINE\\SOFTWARE\\VLE Development Team\\VLE ${VLE_VERSION}.0;Path]/include"
    "[HKEY_LOCAL_MACHINE\\SOFTWARE\\VLE Development Team\\VLE ${VLE_VERSION}.0;]/include"
    "[HKEY_LOCAL_MACHINE\\SOFTWARE\\VLE Development Team\\Wow6432Node\\VLE ${VLE_VERSION}.0;]/include"
        NO_DEFAULT_PATH)

  find_path(_gvle_base_bin gvle.exe PATHS
    $ENV{VLE_BASEPATH}/bin
    ${VLE_BASEPATH_LOCAL}/bin
    "[HKEY_LOCAL_MACHINE\\SOFTWARE\\VLE Development Team\\VLE ${VLE_VERSION}.0;Path]/bin"
    "[HKEY_LOCAL_MACHINE\\SOFTWARE\\VLE Development Team\\VLE ${VLE_VERSION}.0;]/bin"
    "[HKEY_LOCAL_MACHINE\\SOFTWARE\\VLE Development Team\\Wow6432Node\\VLE ${VLE_VERSION}.0;]/bin"
        NO_DEFAULT_PATH)

  find_path(_gvle_base_lib libgvle-${VLE_VERSION}.dll.a PATHS
    $ENV{VLE_BASEPATH}/lib
    ${VLE_BASEPATH_LOCAL}/lib
    "[HKEY_LOCAL_MACHINE\\SOFTWARE\\VLE Development Team\\VLE ${VLE_VERSION}.0;Path]/lib"
    "[HKEY_LOCAL_MACHINE\\SOFTWARE\\VLE Development Team\\VLE ${VLE_VERSION}.0;]/lib"
    "[HKEY_LOCAL_MACHINE\\SOFTWARE\\VLE Development Team\\Wow6432Node\\VLE ${VLE_VERSION}.0;]/lib"
        NO_DEFAULT_PATH)
  ...
  set (GVLE_LIBRARIES
    gvle-${VLE_VERSION} intl)
else () # find gvle using pkg-config
  find_package(PkgConfig REQUIRED)
  PKG_CHECK_MODULES(GVLE gvle-${VLE_VERSION})
endif ()
