...
SUBDIRS += pkg_vle_adapative_qss_adder pkg_vle_adapative_qss_generator pkg_vle_adapative_qss_adaptative-quantifier pkg_vle_adapative_qss_integrator pkg_vle_adapative_qss_mult
